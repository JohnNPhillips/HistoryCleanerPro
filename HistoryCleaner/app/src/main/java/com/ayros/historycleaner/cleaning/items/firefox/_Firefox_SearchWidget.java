...
public class _Firefox_SearchWidget extends CleanItem
{
	public _Firefox_SearchWidget(Category parent)
	{
		super(parent);
	}
	...
	public List<String []> getSavedData()
	{
		...
		if (path == null)
		{
			Logger.error("Could not get FireFox data path to view search widget history");
			return null;
		}
	...
	public boolean clean()
	{
		...
		if (path == null)
		{
			Logger.error("Could not get FireFox data path to clear search widget history");
			return false;
		}
		else if (path.length() == 0)
		{
