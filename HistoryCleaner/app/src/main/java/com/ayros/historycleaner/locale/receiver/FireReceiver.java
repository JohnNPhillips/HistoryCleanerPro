...
public final class FireReceiver extends BroadcastReceiver
{
	 ...
	 * @param intent
	 *            the incoming
	 *            {@link com.twofortyfouram.locale.api.Intent#ACTION_FIRE_SETTING}
	 *            Intent. This should contain the
	 *            {@link com.twofortyfouram.locale.api.Intent#EXTRA_BUNDLE} that was
	 *            saved by EditActivity and later broadcast by Locale.
	 */
	@Override
