...
import com.ayros.historycleaner.legacy.R;
import com.ayros.historycleaner.legacy.cleaning.SimpleDatabaseItem.DBQuery;
...
public class CategoryList
{
	...
	public CategoryList()
	{
		...
		cat.addItem(new com.ayros.historycleaner.legacy.cleaning.items._System_Cache(cat));
		cat.addItem(new com.ayros.historycleaner.legacy.cleaning.items._System_BrowserHistory(cat));
		cat.addItem(new com.ayros.historycleaner.legacy.cleaning.items._System_Clipboard(cat));
		...
		cat.addItem(new com.ayros.historycleaner.legacy.cleaning.items._System_RecentCalls(cat));
		cat.addItem(new com.ayros.historycleaner.legacy.cleaning.items._System_SMS(cat));
		cats.add(cat);
		...
		cat.addItem(new com.ayros.historycleaner.legacy.cleaning.items._AdobeReader_Recent(cat));
		cats.add(cat);
		...
		cat.addItem(new com.ayros.historycleaner.legacy.cleaning.items._Firefox_Cache(cat));
		cat.addItem(new com.ayros.historycleaner.legacy.cleaning.items._Firefox_Cookies(cat));
		cat.addItem(new com.ayros.historycleaner.legacy.cleaning.items._Firefox_History(cat));
		cat.addItem(new com.ayros.historycleaner.legacy.cleaning.items._Firefox_LocalStorage(cat));
		cat.addItem(new com.ayros.historycleaner.legacy.cleaning.items._Firefox_OpenTabs(cat));
		cats.add(cat);
		...
		cat.addItem(new com.ayros.historycleaner.legacy.cleaning.items._ONEBrowser_Cache(cat));
		cat.addItem(new SimpleDatabaseItem
		(
		...
		cat.addItem(new com.ayros.historycleaner.legacy.cleaning.items._ONEBrowser_LocalStorage(cat));
		cats.add(cat);
