...
package com.ayros.historycleaner.legacy.locale;

import android.content.Context;

import com.ayros.historycleaner.legacy.BuildConfig;
...
public final class Constants
{
	...
	public static final String LOG_TAG = "CleanerPlugin"; //$NON-NLS-1$
